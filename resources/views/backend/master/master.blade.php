...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="#"><span>Admin </span>System</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<form role="search">
			...
			<li><a href="/admin/provider"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad" /></svg> Nhà cung cấp</a></li>
			<li><a href="/admin/coupon"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad" /></svg> Mã Coupon</a></li>
